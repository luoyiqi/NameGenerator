...
public class EnglishNames extends Names {

    public static final String SURNAMES_FILENAME = "english_surnames.txt";
    public static final String MALE_NAMES_FILENAME = "english_male.txt";
    public static final String FEMALE_NAMES_FILENAME = "english_female.txt";

    public String[] mMaleNames;
    public String[] mFemaleNames;
    public String[] mSurnames;

    public EnglishNames() throws IOException {
     ...
     * @return A random English name for a certain gender including a given name and a surname
     */
    @Override
