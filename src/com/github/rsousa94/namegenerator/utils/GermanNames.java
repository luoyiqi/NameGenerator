...
public class GermanNames extends Names {

    public static final String SURNAMES_FILENAME = "german_surnames.txt";
    public static final String MALE_NAMES_FILENAME = "german_male.txt";
    public static final String FEMALE_NAMES_FILENAME = "german_female.txt";

    public String[] mMaleNames;
    public String[] mFemaleNames;
    public String[] mSurnames;

    public GermanNames() throws IOException {
     ...
     * @return A random German name for a certain gender including a given name and a surname
     */
    @Override
